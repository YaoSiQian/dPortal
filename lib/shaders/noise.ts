// Shared GLSL noise primitives (Ashima simplex + fbm) for procedural shaders.
// Keep this file tiny — included as a string into every shader that needs it.
...
// Shared vertex shader used by every planet body.
// Exposes object-space position, world-space position, world-space normal,
// and uv (for planets that sample textures, e.g. Earth).
