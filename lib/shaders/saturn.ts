...
// Texture-driven Saturn body. Rings stay procedural (saturnRing shader)
// because the procedural one carries the cast-shadow logic.

export const saturnVertex = PLANET_VERTEX;
